<?php
  function searchHomeGames($database, $search)
  {
  ...
  function searchUserGames($database, $search)
  {
    $tableData = array("active"=>'', "pending"=>'', "finished"=>'');
    try
    {
      $query = '';
